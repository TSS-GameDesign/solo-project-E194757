...
var _health_barw = _barw * (hp / hptotal);
draw_sprite_stretched(spr_box, 0, _dx, _dy * 6, _barw, _barh);
draw_sprite_stretched_ext(spr_box, 1, _dx, _dy * 6, _health_barw, _barh, c_green, 0.6);
